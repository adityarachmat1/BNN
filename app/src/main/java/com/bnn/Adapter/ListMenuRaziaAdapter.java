...
public class ListMenuRaziaAdapter extends ArrayAdapter<Listmenu> {

    final Context ctx;
    final ArrayList<Listmenu> items;
    final LayoutInflater vi;

    public ListMenuRaziaAdapter(Context ctx, ArrayList<Listmenu> items) {
        super(ctx, 0, items);
        this.ctx = ctx;
        this.items = items;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        v = vi.inflate(R.layout.item_listsearch_razia, null);
