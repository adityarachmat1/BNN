...
public class ListMenuPenyiaranAdapter extends ArrayAdapter<MenuPencegahan> {

    final Context ctx;
    final ArrayList<MenuPencegahan> items;
    final LayoutInflater vi;

    public ListMenuPenyiaranAdapter(Context ctx, ArrayList<MenuPencegahan> items) {
        super(ctx, 0, items);
        this.ctx = ctx;
        this.items = items;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            v = vi.inflate(R.layout.item_listsearch_penyiaran, null);
