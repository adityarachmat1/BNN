...
import com.bnn.Adapter.ListMenuPenyiaranAdapter;
...
public class SosialisasiViaMediaPenyiaranActivity extends ActivityBase implements View.OnClickListener {
    ...
    ListMenuPenyiaranAdapter listMenuAdapter;
    Calendar cal;
    String now = "";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_list_sosialisasimediapenyiaran, linearLayout);
        ...
        ArrayList<String> searchlist = new ArrayList<>(Arrays.asList(
                ...
                EnumSearch.JENIS_MEDIA_PENYIARAN.toString()));
        ...
        menulist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                String mediaPenyiaranId = listMenuAdapter.getItem(i).getNoid();

                Intent detilKasus = new Intent(SosialisasiViaMediaPenyiaranActivity.this, DetilSosialisasiViaMediaPenyiaranActivity.class);
                detilKasus.putExtra("mediapenyiaran_id", mediaPenyiaranId);
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (view != null) {
                    ...
                    if (selected.equalsIgnoreCase(EnumSearch.LOKASI.toString()) ||
                            selected.equalsIgnoreCase(EnumSearch.JENIS_MEDIA_PENYIARAN.toString())) {
...
//        menulist.addFooterView(footer);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.imgAdd:
                Intent tambahMediaOnline = new Intent(SosialisasiViaMediaPenyiaranActivity.this, TambahSosialisasiViaMediaPenyiaranActivity.class);
                startActivity(tambahMediaOnline);
                finish();
                break;
            case R.id.btnSearch:
                if (Configuration.isDeviceOnline(SosialisasiViaMediaPenyiaranActivity.this)) {
                    ...
                    } else if (modeCari.equalsIgnoreCase(EnumSearch.JENIS_MEDIA_PENYIARAN.toString())) {
                ...
                break;
            case R.id.imgBack:
                Intent kembaliPencegahan = new Intent(SosialisasiViaMediaPenyiaranActivity.this, PencegahanActivity.class);
                startActivity(kembaliPencegahan);
                finish();
                break;
            case R.id.edTanggalBefore:
                Calendar calendar = Calendar.getInstance();
                DatePickerDialog dpd = new DatePickerDialog(SosialisasiViaMediaPenyiaranActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            case R.id.edTanggalAfter:
                ...
                DatePickerDialog dpd1 = new DatePickerDialog(SosialisasiViaMediaPenyiaranActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
...
//                menulist.addFooterView(footer);
        ...
        protected String doInBackground(Bitmap... b) {
            ...
            Request httpRequest = new Request.Builder()
                    .url(Configuration.baseUrl+"/api/listpenyiaran")
...
//                    .build();
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("sukses")) {
                    ...
                    if (isLoadMore) {
                        ...
                        listMenuAdapter = new ListMenuPenyiaranAdapter(SosialisasiViaMediaPenyiaranActivity.this, menuPencegahanArrayList);
                    ...
                    if (jsonObject.getString("comment").equalsIgnoreCase("token expired")) {
                        ...
                        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(SosialisasiViaMediaPenyiaranActivity.this)
                                ...
                                .setNeutralButton("Keluar", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        Intent logout = new Intent(SosialisasiViaMediaPenyiaranActivity.this, LoginActivity.class);
                    ...
                    Toast.makeText(SosialisasiViaMediaPenyiaranActivity.this, "Failed detect.", Toast.LENGTH_LONG).show();
                }
    ...
    public void onBackPressed() {
        startActivity(new Intent(SosialisasiViaMediaPenyiaranActivity.this, PencegahanActivity.class));
        finish();
    }
