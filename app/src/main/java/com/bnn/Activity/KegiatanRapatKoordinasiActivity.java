...
public class KegiatanRapatKoordinasiActivity extends ActivityBase implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_list_kegiatanrapatkoordinasi, linearLayout);
        ...
        menulist = (ListView) findViewById(R.id.listViewKegiatanRapatKoordinasi);
        ...
        menulist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                String rakorId = listMenuAdapter.getItem(i).getNoid();

                Intent detilKasus = new Intent(KegiatanRapatKoordinasiActivity.this, DetilKegiatanRapatKoordinasiActivity.class);
                detilKasus.putExtra("id", rakorId);
...
//        menulist.addFooterView(footer);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.imgAdd:
                Intent y = new Intent(KegiatanRapatKoordinasiActivity.this, TambahKegiatanRapatKoordinasiActivity.class);
                startActivity(y);
                finish();
                break;
            case R.id.btnSearch:
                if (Configuration.isDeviceOnline(KegiatanRapatKoordinasiActivity.this)) {
                ...
                break;
            case R.id.imgBack:
                Intent pencegahan = new Intent(KegiatanRapatKoordinasiActivity.this, PencegahanActivity.class);
                startActivity(pencegahan);
                finish();
                break;
            case R.id.edTanggalBefore:
                Calendar calendar = Calendar.getInstance();
                DatePickerDialog dpd = new DatePickerDialog(KegiatanRapatKoordinasiActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            case R.id.edTanggalAfter:
                ...
                DatePickerDialog dpd1 = new DatePickerDialog(KegiatanRapatKoordinasiActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
...
//                menulist.addFooterView(footer);
        ...
        protected String doInBackground(Bitmap... b) {
            ...
            Request httpRequest = new Request.Builder()
                    .url(Configuration.baseUrl+"/api/listrakor")
                    .addHeader("Authorization", "Bearer " + prefUtils.getTokenKey())
                    .post(requestBody)
                    .build();

            Log.d("url list_rakoor", Configuration.baseUrl+"/api/listrakor");
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("sukses")) {
                    ...
                    for (int i = 0; i < data.length(); i++) {
                        ...
                        Log.d("Jml", "Jml; "+!list.getString("jumlah_peserta").equals("null"));

                        String meta_sasaran = list.getString("meta_sasaran").replaceAll("\\\\","").replaceAll("[]]","").replace("\"", "").replace("[","");
                        ...
                        menuLists.add(new Listmenu(!list.getString("tgl_pelaksanaan").equals("null") ? list.getString("tgl_pelaksanaan") : "-",
                                !meta_sasaran.equals("null") ? meta_sasaran : "-",
                    ...
                    if (isLoadMore) {
                        ...
                        listMenuAdapter = new ListMenuKegiatanAdapter(KegiatanRapatKoordinasiActivity.this, menuLists);
                    ...
                    if (jsonObject.getString("comment").equalsIgnoreCase("token expired")) {
                        ...
                        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(KegiatanRapatKoordinasiActivity.this)
                                ...
                                .setNeutralButton("Keluar", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        Intent logout = new Intent(KegiatanRapatKoordinasiActivity.this, LoginActivity.class);
                    ...
                    Toast.makeText(KegiatanRapatKoordinasiActivity.this, "Failed detect.", Toast.LENGTH_LONG).show();
                }
    ...
    public void onBackPressed() {
        startActivity(new Intent(KegiatanRapatKoordinasiActivity.this, PencegahanActivity.class));
        finish();
    }
}