...
public class KegiatanMonitoringdanEvaluasiActivity extends ActivityBase implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_list_kegiatanmonitoringdanevaluasi, linearLayout);
        ...
        menulist = (ListView) findViewById(R.id.listViewMonitoringdanEvaluasi);
        ...
        menulist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent detilKasus = new Intent(KegiatanMonitoringdanEvaluasiActivity.this, DetilKegiatanMonitoringEvaluasiActivity.class);
                detilKasus.putExtra("id", penyuluhanId);
...
//        menulist.addFooterView(footer);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.imgAdd:
                Intent y = new Intent(KegiatanMonitoringdanEvaluasiActivity.this, TambahKegiatanMonitoringdanEvaluasiActivity.class);
                startActivity(y);
                finish();
                break;
            case R.id.btnSearch:
                if (Configuration.isDeviceOnline(KegiatanMonitoringdanEvaluasiActivity.this)) {
                ...
                break;
            case R.id.imgBack:
                Intent pencegahan = new Intent(KegiatanMonitoringdanEvaluasiActivity.this, PencegahanActivity.class);
                startActivity(pencegahan);
                finish();
                break;
            case R.id.edTanggalBefore:
                Calendar calendar = Calendar.getInstance();
                DatePickerDialog dpd = new DatePickerDialog(KegiatanMonitoringdanEvaluasiActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            case R.id.edTanggalAfter:
                ...
                DatePickerDialog dpd1 = new DatePickerDialog(KegiatanMonitoringdanEvaluasiActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
...
//                menulist.addFooterView(footer);
        ...
        protected String doInBackground(Bitmap... b) {
            ...
            Request httpRequest = new Request.Builder()
                    .url(Configuration.baseUrl+"/api/listmonev")
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("sukses")) {
                    ...
                    if (isLoadMore) {
                        ...
                        listMenuAdapter = new ListMenuKegiatanAdapter(KegiatanMonitoringdanEvaluasiActivity.this, menuLists);
                    ...
                    if (jsonObject.getString("comment").equalsIgnoreCase("token expired")) {
                        ...
                        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(KegiatanMonitoringdanEvaluasiActivity.this)
                                ...
                                .setNeutralButton("Keluar", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        Intent logout = new Intent(KegiatanMonitoringdanEvaluasiActivity.this, LoginActivity.class);
                    ...
                    Toast.makeText(KegiatanMonitoringdanEvaluasiActivity.this, "Failed detect.", Toast.LENGTH_LONG).show();
                }
    ...
    public void onBackPressed() {
        startActivity(new Intent(KegiatanMonitoringdanEvaluasiActivity.this, PencegahanActivity.class));
        finish();
    }
}