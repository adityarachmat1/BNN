...
import com.bnn.Adapter.ListMenuBimtekAdapter;
import com.bnn.Adapter.ListMenuPelatihanBimtekMonevAdapter;
...
public class PelatihanKonselorActivity extends ActivityBase implements View.OnClickListener {
    private static final String TAG = PelatihanKonselorActivity.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_list_pelatihankonselor, linearLayout);
        ...
        menulist = (ListView) findViewById(R.id.listview_pelatihankonselor);
...
//        menulists.add(new Listmenu("03 November 2017", "KEGIATAN PLRIP", "", "-", "JAKARTA", ""));
//
//        adapter = new ListMenuAdapter(PelatihanKonselorActivity.this, menulists);
...
//                String pelaksana = adapter.getItem(i).getPelaksana();
                ...
                Intent detilKasus = new Intent(PelatihanKonselorActivity.this, DetilPelatihanKonselorActivity.class);
                detilKasus.putExtra("id", id);
//                detilKasus.putExtra("pelaksana", pelaksana);

                Log.d ("Test Id","Hasill...: "+ id);
...
//        menulist.addFooterView(footer);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.imageadd:
                Intent y = new Intent(PelatihanKonselorActivity.this, TambahPelatihanKonselorActivity.class);
                startActivity(y);
                finish();
                break;
            case R.id.button_search:
                if (Configuration.isDeviceOnline(PelatihanKonselorActivity.this)) {
                ...
                break;
            case R.id.imageback:
                Intent dashboardBack = new Intent(PelatihanKonselorActivity.this, RehabilitasiActivity.class);
                startActivity(dashboardBack);
                finish();
                break;
            case R.id.texttanggalbefore:
                Calendar calendar = Calendar.getInstance();
                DatePickerDialog dpd = new DatePickerDialog(PelatihanKonselorActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            case R.id.texttanggalafter:
                ...
                DatePickerDialog dpd1 = new DatePickerDialog(PelatihanKonselorActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
...
//                menulist.addFooterView(footer);
        ...
        protected String doInBackground(Bitmap... b) {
            ...
            Request httpRequest = new Request.Builder()
                    .url(Configuration.baseUrl+"/api/listpelatihan")
...
//                    .build();
            ...
            Log.d("test1", modeCari + " : "+bodyToString(httpRequest));
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("sukses")) {
                    ...
                    for (int i = 0; i < data.length(); i++) {
                        ...
                        menulists.add(new Listmenu(list.getString("tgl_dilaksanakan_mulai"),
                                list.getString("jumlah_peserta"),
                                "-",
                                list.getString("id"),
                                list.getString("tempat"),
                                ""));
                    ...
                    if (isLoadMore) {
                        ...
                        adapter = new ListMenuBimtekAdapter(PelatihanKonselorActivity.this, menulists);
                        menulist.setAdapter(adapter);
                    ...
                    if (jsonObject.getString("comment").equalsIgnoreCase("token expired")) {
                        ...
                        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(PelatihanKonselorActivity.this)
                                ...
                                .setNeutralButton("Keluar", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        Intent logout = new Intent(PelatihanKonselorActivity.this, LoginActivity.class);
                    ...
                    Toast.makeText(PelatihanKonselorActivity.this, "Failed detect.", Toast.LENGTH_LONG).show();
                }
    ...
    public void onBackPressed() {
        startActivity(new Intent(PelatihanKonselorActivity.this, RehabilitasiActivity.class));
        finish();
    }
