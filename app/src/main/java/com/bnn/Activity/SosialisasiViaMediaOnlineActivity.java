...
import com.bnn.Adapter.ListMenuOnlineAdapter;
...
public class SosialisasiViaMediaOnlineActivity extends ActivityBase implements View.OnClickListener {
    ...
    ListMenuOnlineAdapter listMenuAdapter;
    Calendar cal;
    String now = "";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_list_sosialisasimediaonline, linearLayout);
        ...
        menulist = (ListView) findViewById(R.id.listViewMediaOnline);
        ...
        ArrayList<String> searchlist = new ArrayList<>(Arrays.asList(
                ...
                EnumSearch.JENIS_MEDIA_ONLINE.toString()));
        ...
        menulist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                String mediaOnlineId = listMenuAdapter.getItem(i).getNoid();

                Intent detilKasus = new Intent(SosialisasiViaMediaOnlineActivity.this, DetilSosialisasiViaMediaOnlineActivity.class);
                detilKasus.putExtra("mediaonline_id", mediaOnlineId);
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (view != null) {
                    ...
                    if (selected.equalsIgnoreCase(EnumSearch.LOKASI.toString()) ||
                            selected.equalsIgnoreCase(EnumSearch.JENIS_MEDIA_ONLINE.toString())) {
...
//        menulist.addFooterView(footer);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.imgAdd:
                Intent tambahMediaOnline = new Intent(SosialisasiViaMediaOnlineActivity.this, TambahSosialisasiViaMediaOnlineActivity.class);
                startActivity(tambahMediaOnline);
                finish();
                break;
            case R.id.btnSearch:
                if (Configuration.isDeviceOnline(SosialisasiViaMediaOnlineActivity.this)) {
                    ...
                    if (modeCari.equalsIgnoreCase(EnumSearch.LOKASI.toString()) ||
                            modeCari.equalsIgnoreCase(EnumSearch.JENIS_MEDIA_ONLINE.toString())) {
                    ...
                    } else if (modeCari.equalsIgnoreCase(EnumSearch.JENIS_MEDIA_ONLINE.toString())) {
                ...
                break;
            case R.id.imgBack:
                Intent kembaliPencegahan = new Intent(SosialisasiViaMediaOnlineActivity.this, PencegahanActivity.class);
                startActivity(kembaliPencegahan);
                finish();
                break;
            case R.id.edTanggalBefore:
                Calendar calendar = Calendar.getInstance();
                DatePickerDialog dpd = new DatePickerDialog(SosialisasiViaMediaOnlineActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            case R.id.edTanggalAfter:
                ...
                DatePickerDialog dpd1 = new DatePickerDialog(SosialisasiViaMediaOnlineActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
...
//                menulist.addFooterView(footer);
        ...
        protected String doInBackground(Bitmap... b) {
            ...
            Log.d("Test search jenis", keyKataKunci + " : "+ katakunci);

            Request httpRequest = new Request.Builder()
                    .url(Configuration.baseUrl+"/api/listonline")
            ...
            Log.d("jenis", bodyToString(httpRequest));
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("sukses")) {
                    ...
                    for (int i = 0; i < data.length(); i++) {
                        ...
                        menuPencegahanArrayList.add(new MenuPencegahan(!list.getString("tgl_pelaksanaan").equals("null") ? list.getString("tgl_pelaksanaan") : "-",
                                !list.getString("lokasi").equals("null") ? list.getString("lokasi") : "-",
                                !list.getString("jenis_media").equals("null") ? list.getString("jenis_media") : "-",
                    ...
                    if (isLoadMore) {
                        ...
                        listMenuAdapter = new ListMenuOnlineAdapter(SosialisasiViaMediaOnlineActivity.this, menuPencegahanArrayList);
                    ...
                    if (jsonObject.getString("comment").equalsIgnoreCase("token expired")) {
                        ...
                        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(SosialisasiViaMediaOnlineActivity.this)
                                ...
                                .setNeutralButton("Keluar", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        Intent logout = new Intent(SosialisasiViaMediaOnlineActivity.this, LoginActivity.class);
                    ...
                    Toast.makeText(SosialisasiViaMediaOnlineActivity.this, "Failed detect.", Toast.LENGTH_LONG).show();
                }
    ...
    public void onBackPressed() {
        startActivity(new Intent(SosialisasiViaMediaOnlineActivity.this, PencegahanActivity.class));
        finish();
    }
