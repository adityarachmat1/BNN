...
import com.bnn.Adapter.ListMenuAlihFungsiAdapter;
...
public class AlihFungsiLahanActivity extends ActivityBase implements View.OnClickListener {
    private static final String TAG = AlihFungsiLahanActivity.class.getSimpleName();
    //Diupdate pada 14 Nov 2017
    ListView menulist;
    ...
    ListMenuAlihFungsiAdapter adapter;
    ...
    String modeCari = "";
    String tglFrom, tglTo, katakunci, edluasarea;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_list_alihfungsilahan, linearLayout);
        ...
        menulist = (ListView) findViewById(R.id.listview_alihfungsilahan);
...
//        menulists.add(new Listmenu("2017-10-01", "SUMATERA BARAT", "Ganja", "1", "Puncak Gagoan Utara, Sumbar", ""));
//
//        adapter = new ListMenuAdapter(AlihFungsiLahanActivity.this, menulists);
//        menulist.setAdapter(adapter);
        ...
        menulist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent detilAlihFungsi = new Intent(AlihFungsiLahanActivity.this, DetilAlihFungsiPeninjauanLahanActivity.class);
                detilAlihFungsi.putExtra("id", id);

                startActivity(detilAlihFungsi);
                finish();
            }
        });
...
//        menulist.addFooterView(footer);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.imageadd:
                Intent y = new Intent(AlihFungsiLahanActivity.this, TambahAlihFungsiLahanActivity.class);
                startActivity(y);
                finish();
                break;
            case R.id.button_search:
                if (Configuration.isDeviceOnline(AlihFungsiLahanActivity.this)) {
                ...
                break;
            case R.id.imageback:
                Intent dashboardBack = new Intent(AlihFungsiLahanActivity.this, PemberdayaanActivity.class);
                startActivity(dashboardBack);
                finish();
                break;
            case R.id.texttanggalbefore:
                Calendar calendar = Calendar.getInstance();
                DatePickerDialog dpd = new DatePickerDialog(AlihFungsiLahanActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            case R.id.texttanggalafter:
                ...
                DatePickerDialog dpd1 = new DatePickerDialog(AlihFungsiLahanActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
...
//                menulist.addFooterView(footer);
        ...
        protected String doInBackground(Bitmap... b) {
            ...
            Request httpRequest = new Request.Builder()
                    .url(Configuration.baseUrl+"/api/listalihfungsi")
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("sukses")) {
                    ...
                    for (int i = 0; i < data.length(); i++) {
                        ...
                        String meta_lokasi_lahan = list.getString("meta_lokasi_lahan");
                            ...
                            try {
                                ...
                                for (int j = 0; j < jarr.length(); j++){
                                    ...
                                    edluasarea = !obj.getString("luas_lahan").equals("null") ? obj.getString("luas_lahan") : "";
                                }
                            } catch (Throwable t) {
                        ...
                        menulists.add(new Listmenu(list.getString("tgl_kegiatan"),
                                edluasarea,
                                "",
                                list.getString("id"),
...
//                        Log.d("cobadatalist","data : " + data.toString() + "\ntgl: " + list.getString("tgl_kegiatan")
//                                + "\nnamakegiatan: " + list.getString("nama_kegiatan") + "\nbarangbukti: " + list.getString("kodekomoditi")
//                                + "\nlokasi : " + list.getString("lokasi"));
                    }
                    ...
                    if (isLoadMore) {
                        ...
                        adapter = new ListMenuAlihFungsiAdapter(AlihFungsiLahanActivity.this, menulists);
                        menulist.setAdapter(adapter);
                    ...
                    if (jsonObject.getString("comment").equalsIgnoreCase("token expired")) {
                        ...
                        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(AlihFungsiLahanActivity.this)
                                ...
                                .setNeutralButton("Keluar", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        Intent logout = new Intent(AlihFungsiLahanActivity.this, LoginActivity.class);
                    ...
                    Toast.makeText(AlihFungsiLahanActivity.this, "Failed detect.", Toast.LENGTH_LONG).show();
                }
    ...
    public void onBackPressed() {
        startActivity(new Intent(AlihFungsiLahanActivity.this, PemberdayaanActivity.class));
        finish();
    }
