...
public class KegiatanMembangunJejaringActivity extends ActivityBase implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_list_kegiatanmembangunjejaring, linearLayout);
        ...
        menulist = (ListView) findViewById(R.id.listViewKegiatanMembangunJejaring);
        ...
        menulist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                String jejaringId = listMenuAdapter.getItem(i).getNoid();

                Intent detilKasus = new Intent(KegiatanMembangunJejaringActivity.this, DetilKegiatanMembangunJejaringActivity.class);
                detilKasus.putExtra("id", jejaringId);
...
//        menulist.addFooterView(footer);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.imgAdd:
                Intent y = new Intent(KegiatanMembangunJejaringActivity.this, TambahKegiatanMembangunJejaringActivity.class);
                startActivity(y);
                finish();
                break;
            case R.id.btnSearch:
                if (Configuration.isDeviceOnline(KegiatanMembangunJejaringActivity.this)) {
                ...
                break;
            case R.id.imgBack:
                Intent pencegahan = new Intent(KegiatanMembangunJejaringActivity.this, PencegahanActivity.class);
                startActivity(pencegahan);
                finish();
                break;
            case R.id.edTanggalBefore:
                Calendar calendar = Calendar.getInstance();
                DatePickerDialog dpd = new DatePickerDialog(KegiatanMembangunJejaringActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            case R.id.edTanggalAfter:
                ...
                DatePickerDialog dpd1 = new DatePickerDialog(KegiatanMembangunJejaringActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
...
//                menulist.addFooterView(footer);
        ...
        protected String doInBackground(Bitmap... b) {
            ...
            Request httpRequest = new Request.Builder()
                    .url(Configuration.baseUrl+"/api/listjejaring")
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("sukses")) {
                    ...
                    if (isLoadMore) {
                        ...
                        listMenuAdapter = new ListMenuKegiatanAdapter(KegiatanMembangunJejaringActivity.this, menuLists);
                    ...
                    if (jsonObject.getString("comment").equalsIgnoreCase("token expired")) {
                        ...
                        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(KegiatanMembangunJejaringActivity.this)
                                ...
                                .setNeutralButton("Keluar", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        Intent logout = new Intent(KegiatanMembangunJejaringActivity.this, LoginActivity.class);
                    ...
                    Toast.makeText(KegiatanMembangunJejaringActivity.this, "Failed detect.", Toast.LENGTH_LONG).show();
                }
    ...
    public void onBackPressed() {
        startActivity(new Intent(KegiatanMembangunJejaringActivity.this, PencegahanActivity.class));
        finish();
    }
}