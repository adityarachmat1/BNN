...
public class KegiatanIntervensiActivity extends ActivityBase implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_list_kegiatanintervensi, linearLayout);
        ...
        menulist = (ListView) findViewById(R.id.listViewKegiatanIntervensi);
        ...
        menulist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                String intervensiId = listMenuAdapter.getItem(i).getNoid();

                Intent detilKasus = new Intent(KegiatanIntervensiActivity.this, DetilKegiatanIntervensiActivity.class);
                detilKasus.putExtra("id", intervensiId);
...
//        menulist.addFooterView(footer);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.imgAdd:
                Intent y = new Intent(KegiatanIntervensiActivity.this, TambahKegiatanIntervensiActivity.class);
                startActivity(y);
                finish();
                break;
            case R.id.btnSearch:
                if (Configuration.isDeviceOnline(KegiatanIntervensiActivity.this)) {
                ...
                break;
            case R.id.imgBack:
                Intent pencegahan = new Intent(KegiatanIntervensiActivity.this, PencegahanActivity.class);
                startActivity(pencegahan);
                finish();
                break;
            case R.id.edTanggalBefore:
                Calendar calendar = Calendar.getInstance();
                DatePickerDialog dpd = new DatePickerDialog(KegiatanIntervensiActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            case R.id.edTanggalAfter:
                ...
                DatePickerDialog dpd1 = new DatePickerDialog(KegiatanIntervensiActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
...
//                menulist.addFooterView(footer);
        ...
        protected String doInBackground(Bitmap... b) {
            ...
            Request httpRequest = new Request.Builder()
                    .url(Configuration.baseUrl+"/api/listintervensi")
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("sukses")) {
                    ...
                    if (isLoadMore) {
                        ...
                        listMenuAdapter = new ListMenuKegiatanAdapter(KegiatanIntervensiActivity.this, menuLists);
                    ...
                    if (jsonObject.getString("comment").equalsIgnoreCase("token expired")) {
                        ...
                        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(KegiatanIntervensiActivity.this)
                                ...
                                .setNeutralButton("Keluar", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        Intent logout = new Intent(KegiatanIntervensiActivity.this, LoginActivity.class);
                    ...
                    Toast.makeText(KegiatanIntervensiActivity.this, "Failed detect.", Toast.LENGTH_LONG).show();
                }
    ...
    public void onBackPressed() {
        startActivity(new Intent(KegiatanIntervensiActivity.this, PencegahanActivity.class));
        finish();
    }
}