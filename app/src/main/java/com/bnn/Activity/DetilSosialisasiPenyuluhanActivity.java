...
public class DetilSosialisasiPenyuluhanActivity extends ActivityBase implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_detil_sosialisasipenyuluhan, linearLayout);

        penyuluhabIDIntent = getIntent().getStringExtra("penyuluhan_id");
...
//        Ditambahkan pada 07 No 2017
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.imgToogleMenu:
                ...
                break;
            case R.id.imgBack:
                Intent penangananKasus = new Intent(DetilSosialisasiPenyuluhanActivity.this, SosialisasiPenyuluhanActivity.class);
                startActivity(penangananKasus);
                finish();
                break;
            case R.id.imgAdd:
                Intent tambahPenangananKasus = new Intent(DetilSosialisasiPenyuluhanActivity.this, TambahSosialisasiPenyuluhanActivity.class);
            ...
            case R.id.imgJumlahPeserta:
                ...
                pesertaArrayList.add(new Peserta("Peserta 1", "Laki-Laki"));
                pesertaArrayList.add(new Peserta("Peserta 2", "Laki-Laki"));
                pesertaArrayList.add(new Peserta("Peserta 3", "Laki-Laki"));
                pesertaArrayList.add(new Peserta("Peserta 4", "Laki-Laki"));
                pesertaArrayList.add(new Peserta("Peserta 5", "Perempuan"));

                listPeserta = new ListPesertaAdapter(DetilSosialisasiPenyuluhanActivity.this, pesertaArrayList);
            ...
            case R.id.imgLokasiKegiatan:
                ...
                final AlertDialog alertDialog = new AlertDialog.Builder(DetilSosialisasiPenyuluhanActivity.this)
                        .setCancelable(false)
                ...
                btnYa.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Intent mapIntent = new Intent(DetilSosialisasiPenyuluhanActivity.this, MapsActivity.class);
            ...
            case R.id.btnHapus:
                ...
                //Init alert dialog yang akan digunakan sebagai media untuk menampilkan jendela form
                final AlertDialog alertDialogJml = new AlertDialog.Builder(DetilSosialisasiPenyuluhanActivity.this)
                        .setCancelable(false)
                ...
                break;
            case R.id.btnUbah:
                Intent ubahIntent = new Intent(DetilSosialisasiPenyuluhanActivity.this, TambahSosialisasiPenyuluhanActivity.class);
                ubahIntent.putExtra("penyuluhan_id", penyuluhabIDIntent);
            ...
            case R.id.imgDownloadLaporan:
                ...
                //Init alert dialog yang akan digunakan sebagai media untuk menampilkan jendela form
                final AlertDialog alertDialogDownload = new AlertDialog.Builder(DetilSosialisasiPenyuluhanActivity.this)
                        .setCancelable(false)
                ...
                btnYa.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent logoutIntent = new Intent(DetilSosialisasiPenyuluhanActivity.this, SosialisasiPenyuluhanActivity.class);
    ...
    class DataUploadTask extends AsyncTask<Bitmap, Integer, String> {
        ...
        protected String doInBackground(Bitmap... b) {
            ...
            Request httpRequest = new Request.Builder()
                    .url(Configuration.baseUrl+"/api/advoasistensi/"+penyuluhabIDIntent)
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("sukses")) {
                    ...
                    edSumberBiaya.setText(!data.getString("kodesumberanggaran").equals("null") ? data.getString("kodesumberanggaran") : "-");
                    edLaporan.setText("-");
                    ...
                    if (jsonObject.getString("comment").equalsIgnoreCase("token expired")) {
                        ...
                        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(DetilSosialisasiPenyuluhanActivity.this)
                                ...
                                .setNeutralButton("Keluar", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        Intent logout = new Intent(DetilSosialisasiPenyuluhanActivity.this, LoginActivity.class);
    ...
    class DataDeleteTask extends AsyncTask<Bitmap, Integer, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("sukses")) {
                    Toast.makeText(DetilSosialisasiPenyuluhanActivity.this, "Berhasil menghapus data.", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        startActivity(new Intent(this, SosialisasiPenyuluhanActivity.class));
        finish();
    }
}
