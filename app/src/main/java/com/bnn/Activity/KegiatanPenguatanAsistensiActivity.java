...
public class KegiatanPenguatanAsistensiActivity extends ActivityBase implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_list_kegiatanpenguatanasistensi, linearLayout);
        ...
        menulist = (ListView) findViewById(R.id.listViewKegiatanPenguatanAsistensi);
        ...
        menulist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                String penguatanId = listMenuAdapter.getItem(i).getNoid();

                Intent detilKasus = new Intent(KegiatanPenguatanAsistensiActivity.this, DetilKegiatanPenguatanAsistensiActivity.class);
                detilKasus.putExtra("penguatan_id", penguatanId);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.imgAdd:
                Intent y = new Intent(KegiatanPenguatanAsistensiActivity.this, TambahKegiatanPenguatanAsistensiActivity.class);
                startActivity(y);
                finish();
                break;
            case R.id.btnSearch:
                ...
                break;
            case R.id.imgBack:
                Intent pencegahan = new Intent(KegiatanPenguatanAsistensiActivity.this, PencegahanActivity.class);
                startActivity(pencegahan);
                finish();
                break;
            case R.id.edTanggalBefore:
                Calendar calendar = Calendar.getInstance();
                DatePickerDialog dpd = new DatePickerDialog(KegiatanPenguatanAsistensiActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            case R.id.edTanggalAfter:
                ...
                DatePickerDialog dpd1 = new DatePickerDialog(KegiatanPenguatanAsistensiActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
    ...
    class DataUploadTask extends AsyncTask<Bitmap, Integer, String> {
        ...
        protected String doInBackground(Bitmap... b) {
            ...
            Request httpRequest = new Request.Builder()
                    .url(Configuration.baseUrl+"/api/listpenguatan")
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("sukses")) {
                    ...
                    listMenuAdapter = new ListMenuAdapter(KegiatanPenguatanAsistensiActivity.this, menuLists);
                    ...
                    if (jsonObject.getString("comment").equalsIgnoreCase("token expired")) {
                        ...
                        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(KegiatanPenguatanAsistensiActivity.this)
                                ...
                                .setNeutralButton("Keluar", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        Intent logout = new Intent(KegiatanPenguatanAsistensiActivity.this, LoginActivity.class);
                    ...
                    Toast.makeText(KegiatanPenguatanAsistensiActivity.this, "Failed detect.", Toast.LENGTH_LONG).show();
                }
    ...
    public void onBackPressed() {
        startActivity(new Intent(KegiatanPenguatanAsistensiActivity.this, PencegahanActivity.class));
        finish();
    }
}