...
import com.bnn.Adapter.ListMenuKonvensionalAdapter;
...
public class SosialisasiViaMediaKonvensionalActivity extends ActivityBase implements View.OnClickListener {
    private static final String TAG = SosialisasiViaMediaKonvensionalActivity.class.getSimpleName();
    ...
    ListMenuKonvensionalAdapter adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        getLayoutInflater().inflate(R.layout.activity_list_sosialisasimediakonvensional, linearLayout);
        ...
        menulist = (ListView) findViewById(R.id.listview_sosialisasiviamediakonvensional);
...
//
//        adapter = new ListMenuAdapter(SosialisasiViaMediaKonvensionalActivity.this, menulists);
//        menulist.setAdapter(adapter);
        ...
        menulist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                Intent detilKasus = new Intent(SosialisasiViaMediaKonvensionalActivity.this, DetilSosialisasiviamediakonvensionalActivity.class);
...
//        menulist.addFooterView(footer);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.imageadd:
                Intent y = new Intent(SosialisasiViaMediaKonvensionalActivity.this, TambahSosialisasiViaMediaKonvensionalActivity.class);
                startActivity(y);
                finish();
                break;
            case R.id.button_search:
                if (Configuration.isDeviceOnline(SosialisasiViaMediaKonvensionalActivity.this)) {
                    ...
                    if (modeCari.equalsIgnoreCase(EnumSearch.LOKASI.toString())) {
                    ...
                    } else if (modeCari.equalsIgnoreCase(EnumSearch.SASARAN.toString())) {
                        ...
                        } else if (txttanggalafter.getText().toString().equals("")) {
                ...
                break;
            case R.id.imageback:
                Intent dashboardBack = new Intent(SosialisasiViaMediaKonvensionalActivity.this, PencegahanActivity.class);
                startActivity(dashboardBack);
                finish();
                break;
            case R.id.texttanggalbefore:
                Calendar calendar = Calendar.getInstance();
                DatePickerDialog dpd = new DatePickerDialog(SosialisasiViaMediaKonvensionalActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
            ...
            case R.id.texttanggalafter:
                ...
                DatePickerDialog dpd1 = new DatePickerDialog(SosialisasiViaMediaKonvensionalActivity.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
...
//                menulist.addFooterView(footer);
        ...
        protected String doInBackground(Bitmap... b) {
            ...
            Request httpRequest = new Request.Builder()
                    .url(Configuration.baseUrl+"/api/listkonven")
...
//                    .build();
            ...
            try {
                ...
                if (jsonObject.getString("status").equalsIgnoreCase("sukses")) {
                    ...
                    for (int i = 0; i < data.length(); i++) {
                        ...
                        menulists.add(new Listmenu(list.getString("tgl_pelaksanaan"),
                                list.getString("materi"),
                                list.getString("kodesasaran"),
                                list.getString("id"),
                                list.getString("lokasi_kegiatan"),
                                ""));
                    }
                    ...
                    if (isLoadMore) {
                        ...
                        adapter = new ListMenuKonvensionalAdapter(SosialisasiViaMediaKonvensionalActivity.this, menulists);
                        menulist.setAdapter(adapter);
                    ...
                    if (jsonObject.getString("comment").equalsIgnoreCase("token expired")) {
                        ...
                        AlertDialog.Builder alertBuilder = new AlertDialog.Builder(SosialisasiViaMediaKonvensionalActivity.this)
                                ...
                                .setNeutralButton("Keluar", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialogInterface, int i) {
                                        Intent logout = new Intent(SosialisasiViaMediaKonvensionalActivity.this, LoginActivity.class);
                    ...
                    Toast.makeText(SosialisasiViaMediaKonvensionalActivity.this, "Failed detect.", Toast.LENGTH_LONG).show();
                }
    ...
    public void onBackPressed() {
        startActivity(new Intent(SosialisasiViaMediaKonvensionalActivity.this, PencegahanActivity.class));
        finish();
    }
