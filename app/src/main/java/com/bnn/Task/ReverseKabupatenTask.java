 ...
 */
public class ReverseKabupatenTask extends AsyncTask<Void, String, String> {
    ...
    public ReverseKabupatenTask(Context ctx, double latitude, double longitude, ReverseAddress reverseAddress){
        this.ctx = ctx;
    ...
    private String getAddressFromLocation(final double latitude, final double longitude,
        ...
        try {
            ...
            if (addressList != null && addressList.size() > 0) {
                ...
                Log.d(TAG, "Address: "+address.getSubAdminArea());
...
//                }
                ...
                Log.d("kabupaten", address.getSubAdminArea());
                Log.d("kabupaten", address.getAdminArea());
                Log.d("kabupaten", address.getLocality());
                return result;
            }
        } catch (IOException e) {
